...
|---|---|---|---|---|
| SNOWC-01 | Role-Based Entitlement to AI Functions | Access Control | Preventive | R-01 |
| SNOWC-02 | Privileged AI Role Access Review | Access Control | Detective | R-01 |
| SNOWC-03 | PII Masking Before AI Processing | Data Protection | Preventive | R-06 |
| SNOWC-04 | Data Classification Gate for AI Enablement | Data Protection | Preventive | R-11 |
| SNOWC-05 | AI Consumption Budgets and Resource Monitors | Monitoring | Detective | R-17 |
| SNOWC-06 | AI Usage Anomaly and Shadow-Adoption Monitoring | Monitoring | Detective | R-18, R-02 |
| SNOWC-07 | AI Interaction Audit Logging | Logging | Detective | R-08, R-02 |
...
| ID | Control Name | Category | Type | Mitigates (Risk ID) |
|---|---|---|---|---|
| SNOWC-10 | Least-Privilege Agent and Connector Scoping | Access Control | Preventive | R-03, R-04 |
| SNOWC-11 | Data Residency Verification per Model | Data Protection | Preventive | R-13 |
| SNOWC-12 | Agent External Action Log Review | Logging | Detective | R-15 |
| SNOWC-13 | External Connector Approval Process | Third Party Risk | Preventive | R-10, R-02 |
| SNOWC-14 | Human-in-the-Loop Gate for Consequential Agent Actions | Human Oversight | Preventive | R-15 |
| SNOWC-15 | Semantic Model Validation Before Business Rollout | Human Oversight | Preventive | R-14 |
| SNOWC-16 | AI Acceptable Use Training | Human Oversight | Preventive | R-14 |
| SNOWC-17 | LLM Guardrails Enforcement | Responsible AI | Preventive | R-20, R-16 |
| SNOWC-18 | AI Use-Case Intake and Risk Classification | Responsible AI | Preventive | R-07, R-16 |
| SNOWC-19 | AI Incident Response Plan | Incident Response | Corrective | R-20, R-15 |
...
**Type:** Preventive · **Mitigates:** R-01 (unauthorised access via default-on entitlement) · **NIST 800-53:** AC-3, AC-6
...
**Type:** Detective · **Mitigates:** R-01 (default-on entitlement) · **NIST 800-53:** AC-2, AC-6(7)
...
**Type:** Preventive · **Mitigates:** R-06 (PII exposure in prompts and outputs), R-05 (processing personal data without lawful basis) · **NIST 800-53:** SI-19, AC-3
...
**Type:** Preventive · **Mitigates:** R-11 (sensitive data enabled for AI without classification), R-12 (sensitive data persisting in AI-derived artifacts) · **NIST 800-53:** RA-2
...
**Type:** Detective · **Mitigates:** R-17 (uncontrolled consumption cost) · **NIST 800-53:** no direct analog — operational/financial control (800-53 is a security catalogue and does not address cost management)
...
**Type:** Detective · **Mitigates:** R-18 (shadow AI usage), R-02 (data exfiltration) · **NIST 800-53:** AU-6, SI-4
...
**Type:** Detective · **Mitigates:** R-08 (missing audit evidence for AI activity), R-02 (data exfiltration) · **NIST 800-53:** AU-2, AU-12, AU-11
...
**Type:** Preventive · **Mitigates:** R-10 (unreviewed third-party terms) · **NIST 800-53:** SA-9, SA-4
...
**Type:** Detective · **Mitigates:** R-09 (model or service deprecation), R-19 (preview-feature instability in production) · **NIST 800-53:** SA-9
...
**Type:** Preventive · **Mitigates:** R-03 (prompt injection), R-04 (integration credential compromise) · **NIST 800-53:** AC-6, CM-7
...
**Type:** Preventive · **Mitigates:** R-13 (data-residency breach via model processing region) · **NIST 800-53:** SA-9(5)
...
**Type:** Detective · **Mitigates:** R-15 (autonomous agent actions without human review) · **NIST 800-53:** AU-6(1), AC-6(9)
...
**Type:** Preventive · **Mitigates:** R-10 (unreviewed third-party terms), R-02 (data exfiltration) · **NIST 800-53:** CA-3, SA-9
...
**Type:** Preventive · **Mitigates:** R-15 (autonomous agent actions without human review) · **NIST 800-53:** AC-6(9) · **NIST AI RMF:** Manage 2.4
...
**Type:** Preventive · **Mitigates:** R-14 (over-trust of hallucinated or inaccurate outputs) · **NIST AI RMF:** Measure 2.5
...
**Type:** Preventive · **Mitigates:** R-14 (over-trust of outputs) · **NIST 800-53:** AT-2, AT-3
...
**Type:** Preventive · **Mitigates:** R-20 (harmful or biased public-facing output), R-16 (bias in AI outputs) · **NIST AI RMF:** Manage 1.3
...
**Type:** Preventive · **Mitigates:** R-07 (unclassified use cases reaching production), R-16 (bias) · **NIST AI RMF:** Map 1.1 · **EU AI Act:** risk-tier classification
...
**Type:** Corrective · **Mitigates:** R-20 (harmful public-facing output), R-15 (erroneous agent actions) · **NIST 800-53:** IR-4, IR-8
